...
import installer from './NativePixelcamEngine';
...
export * from './generated/pixelcam_engine_ffi';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as pixelcam_engine_ffi from './generated/pixelcam_engine_ffi';
...
if (!initialized) {
  pixelcam_engine_ffi.default.initialize();
  initialized = true;
}
